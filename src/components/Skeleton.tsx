...
export function LeasesPageSkeleton() {
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
        {/* Mobile cards */}
        <div className="md:hidden bg-white rounded-xl shadow-sm border border-slate-200 divide-y divide-slate-200">
          <LeaseCardSkeleton />
          <LeaseCardSkeleton />
          <LeaseCardSkeleton />
          <LeaseCardSkeleton />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
          ...
          {['Open', 'In Progress', 'Completed'].map((col) => (
            <div key={col} className="bg-slate-100 rounded-xl p-3 sm:p-4">
              <div className="flex items-center justify-between mb-3">
